...
Original file is located at
    https://colab.research.google.com/drive/1Rg9VGy_2VD7KZYvNZTSUyKo_FavSpIzE
...
#save model
model.save('./content/drive/model_bert_squad_128.h5')
...
df.to_csv('./content/drive/squad_bert_128.csv', index=False)
